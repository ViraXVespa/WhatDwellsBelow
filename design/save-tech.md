...
- Save data MUST persist across sessions and include at minimum:
  - Permanent XP and levels for the eleven skills in the skills door
  - Banked gold
...
Player-facing restock rule: the inventory / meta job. Thresholds stay tunable and persist with the other debug overrides.
