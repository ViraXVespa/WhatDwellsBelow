...
See also: `AGENTS.md`, `design/constraints.md`, `design/web-session.md`, `design/grok-build.md`, `design/copilot-session.md`, `design/refactor.md`, `design/versioning.md`, `design/sessions.md`, `design/session-log.md`, `design/art-pipeline.md`
...
- Copilot MUST follow `design/copilot-session.md`. MUST use `design/refactor.md` on every task. MUST NOT implement features or invent systems. MUST NOT write `design/sessions.md`, `design/session-log.md`, or `design/changelog/`.
...
- `design/archives.md` governs Archives isolation and MUST be obeyed. Pins are frozen commits. New archives are created only when the User explicitly requests one, except the standing Grok Build week pins in `design/versioning.md` when the User has said **new week**. Copilot MUST NOT create or rewrite archives.
