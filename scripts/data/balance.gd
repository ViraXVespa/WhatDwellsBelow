...
var forge_root := 2.0
var forge_time := 2.0
var forge_gold_per_lv := 3.0
var forge_ore_per_lv := 1.0
var forge_wood := 4.0
var forge_wood_per_lv := 1.0
var forge_blue_mult := 1.45
var forge_lock_mult := 2.0
var forge_smith_disc := 0.03
var forge_time_min := 0.35
var forge_time_max := 8.0
var forge_time_step := 1.15
var forge_quality_per_lv := 0.03
var forge_luck_window := 0.25
var affix_flat_base := 2.0
var affix_flat_per_lv := 0.35
var affix_pct_base := 0.02
var affix_pct_per_lv := 0.004
var affix_rarity_green := 1.15
var affix_rarity_blue := 1.35
var affix_quality_min := 0.5
var affix_quality_max := 1.0
var affix_luck_min := 0.75
var affix_luck_max := 1.25
var affix_white_quality := 0.5
var affix_white_luck := 0.75
var xp_keep := 0.2
