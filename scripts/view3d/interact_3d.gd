...
func _build() -> void:
	...
	match kind:
		"town_crystal":
			...
			_spr_from(tex_path if tex_path != "" else "res://assets/sprites/props/crystal.png", 1.35, true)
			V3.add_box(self, Vector3(0.85, 0.45, 0.45), Vector3(0, 0.22, 0.2))
		"receptionist":
			prompt = "Talk: Guild clerk"
			_spr_from("res://assets/sprites/npcs/receptionist.png", 1.1, true)
			V3.add_cyl(self, 0.18, 0.5, Vector3(0, 0.25, 0))
		"sign":
			prompt = title if title != "" else "Sign"
			_spr_from(tex_path if tex_path != "" else "res://assets/sprites/props/sign.png", 0.95 if tex_path.ends_with("dumpster.png") else 0.85, true)
		...
		"vendor":
			...
			_spr_from("res://assets/sprites/npcs/vendor.png", 1.05, true)
			V3.add_cyl(self, 0.2, 0.5, Vector3(0, 0.25, 0.1))
		"anvil":
			prompt = "Anvil"
			_spr_from("res://assets/sprites/props/anvil.png", 0.7, true)
		...
		"stairs":
			...
			_spr_from("res://assets/sprites/props/stairs.png", 1.0, true)
			V3.add_box(self, Vector3(0.7, 0.2, 0.7), Vector3(0, 0.1, 0))
		"floor_crystal":
			prompt = "Floor crystal"
			process_mode = Node.PROCESS_MODE_ALWAYS
			_spr_from("res://assets/sprites/props/crystal.png", 1.2, true)
			V3.add_box(self, Vector3(0.55, 0.4, 0.55), Vector3(0, 0.2, 0))
		"mining":
			prompt = "Mine ore"
			remaining = rng.randi_range(3, 5)
			_spr_from("res://assets/sprites/props/ore.png", 0.75, true)
			V3.add_box(self, Vector3(0.8, 0.7, 0.8), Vector3(0, 0.35, 0))
		"loot_stash":
			prompt = "Search stash"
			_spr_from("res://assets/sprites/props/chest.png", 0.75, true)
			V3.add_box(self, Vector3(0.7, 0.5, 0.55), Vector3(0, 0.25, 0))
		"campfire":
			prompt = "Warm up"
			_spr_from("res://assets/sprites/props/campfire.png", 0.7, true)
		...
		"ghost_shop":
			...
			_spr_from("res://assets/sprites/npcs/shopkeep.png", 1.1, true)
			if spr:
				spr.modulate = Color(0.75, 0.9, 1.0, 0.92)
			V3.add_cyl(self, 0.25, 0.6, Vector3(0, 0.3, 0))
		"artifact_chest":
			prompt = "Open chest"
			_spr_from("res://assets/sprites/props/chest.png", 0.8, true)
			if spr:
