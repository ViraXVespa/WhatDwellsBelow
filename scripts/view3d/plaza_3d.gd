...
func _build_ground() -> void:
	...
	if not grass_p.is_empty():
		add_child(V3.tile_mm("res://assets/tiles/plaza_grass.png", grass_p, 0.0))
	if not ga_p.is_empty():
		add_child(V3.tile_mm("res://assets/tiles/plaza_ground.png", ga_p, 0.0))
	if not gb_p.is_empty():
		add_child(V3.tile_mm("res://assets/tiles/plaza_ground_b.png", gb_p, 0.0))
...
func _buildings() -> void:
	var guild := _place_cutout("res://assets/sprites/buildings/guild.png", Vector2(9.4, 11.2), 0.88)
	if guild:
		V3.block_px(walls, Vector2(guild.position.x, guild.position.z), Vector2(150, 42), Vector2(0, -16), 1.6)
	var wing := _place_cutout("res://assets/sprites/buildings/guild_reception.png", Vector2(15.0, 11.4), 1.0)
	if wing:
	...
	var stall := _place_cutout("res://assets/sprites/buildings/stall.png", Vector2(28.4, 11.3), 0.92)
	if stall:
...
func _props() -> void:
	_prop("town_crystal", Vector2(20.0, 9.2), "res://assets/sprites/props/crystal.png")
	_prop("receptionist", Vector2(15.0, 10.55))
	_prop("sign", Vector2(7.2, 12.4), "res://assets/sprites/props/sign.png", {
		"title": "Guild notice",
		"body": "Diver board. Pack food. Mail ore. Don't die with a full bag if you can help it.",
	})
	_prop("vendor", Vector2(28.4, 12.0))
	_prop("anvil", Vector2(8.2, 18.2), "res://assets/sprites/props/anvil.png")
	_prop("sign", Vector2(30.2, 18.4), "res://assets/sprites/props/dumpster.png", {
		"title": "Dumpster",
		"body": "You used to eat from this. Career upgrade pending.",
	})
	_prop("sign", Vector2(18.5, 16.6), "res://assets/sprites/props/notice_board.png", {
		"title": "Notice board",
