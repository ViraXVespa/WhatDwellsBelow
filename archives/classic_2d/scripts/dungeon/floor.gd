...
const GhostShopS := preload("res://archives/classic_2d/scripts/entities/ghost_shop.gd")
const ArtifactChestS := preload("res://archives/classic_2d/scripts/entities/artifact_chest.gd")
const FireTrapS := preload("res://archives/classic_2d/scripts/entities/fire_trap.gd")
const GateDoorS := preload("res://archives/classic_2d/scripts/entities/gate_door.gd")
const PressurePlateS := preload("res://archives/classic_2d/scripts/entities/pressure_plate.gd")
const DungeonLeverS := preload("res://archives/classic_2d/scripts/entities/dungeon_lever.gd")
const CrackedWallS := preload("res://archives/classic_2d/scripts/entities/cracked_wall.gd")
...
func _draw_tiles() -> void:
	...
	vis.name = "Tiles"
	vis.z_index = -2
	vis.set_script(preload("res://archives/classic_2d/scripts/dungeon/tile_draw.gd"))
