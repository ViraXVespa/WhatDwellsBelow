# Title -> Placeholdia load-timing smoke. Writes a short summary agents can read.
# Usage (from repo root):
#   powershell -File tools/run_load_timing.ps1
#   powershell -File tools/run_load_timing.ps1 -TimeoutSec 180
...
$OutDir = Join-Path $Root "_logs\load-timing"
